...
const services = [
    ...
    { id: '02', title: 'Заправка кондиционеров', desc: 'Диагностика и заправка автокондиционеров на автоматической заправочной станции. Проверяем герметичность системы, определяем утечки и заправляем фреоном с точностью до грамма.', price: 'от 3500 ₽' },
